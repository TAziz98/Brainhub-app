...
describe('API put-offer end-point', () => {
   ...
   // TODO: before running the test, make sure documenId exists
    const mockDocumentId = "5c007f32-ccb4-4712-86e2-4dccc7a90acb";
  
    // TODO: documentId should be placed in the body of request, to keep both ids same 
